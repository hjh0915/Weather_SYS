...
<html>
    ...
    <body class="text-center">
            <form name="form3" class="form-signin" action="${BASE_PATH}/admin/login" method="post">
                <h1 class="h3 mb-3 font-weight-normal">管理员登录</h1>
                <label for="inputEmail" class="sr-only">管理员姓名</label>
                <input type="text" id="uname" name="uname" class="form-control" placeholder="管理员姓名" required autofocus>
